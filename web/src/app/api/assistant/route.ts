...
- filterPipeline {"tab":"OFFER","min":4,"q":"text","sort":"score","dir":-1} — filter the pipeline table in place. tab ∈ INBOX, ALL, EVALUATED, INTERESTED, READY TO APPLY, APPLIED, RESPONDED, INTERVIEW, OFFER, HIRED, REJECTED, DISCARDED, APPLICATION SKIPPED, BELOW THE BAR, SKIP; min = score floor 0–5.
...
- setStatus {"n":"42","status":"Applied"} — move a tracked application to a new state (asks the user to confirm first). Canonical states: Evaluated, Interested, Ready to Apply, Applied, Responded, Interview, Offer, Hired, Rejected, Discarded, Application Skipped, Below the Bar, SKIP. Use the application number (the "#42" on its report page).
