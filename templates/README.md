...
Defines the 12 canonical application states (`Evaluated`, `Interested`, `Ready to Apply`, `Applied`, `Responded`, `Interview`, `Offer`, `Hired`, `Rejected`, `Discarded`, `Application Skipped`, `SKIP`) with aliases for common variants. All pipeline scripts validate statuses against this file.
